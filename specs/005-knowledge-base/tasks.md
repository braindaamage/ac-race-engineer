...
- [ ] T001 Create knowledge package directory structure: `backend/ac_engineer/knowledge/` with empty `__init__.py`, and `backend/ac_engineer/knowledge/docs/` directory
- [ ] T002 Create test package directory structure: `backend/tests/knowledge/` with empty `__init__.py`
